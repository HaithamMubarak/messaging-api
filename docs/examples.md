...
**Request:**
```bash
curl 'https://hmdevonline.com/messaging-api/origin-service/connect'   --data-raw '{
...
**Request:**
```bash
curl 'https://hmdevonline.com/messaging-api/origin-service/list-agents'   --data-raw '{"session":"042e84ca3232416f9eaecc3818fd67be"}'
```
...
**Request:**
```bash
curl 'https://hmdevonline.com/messaging-api/origin-service/event'   --data-raw '{
    "type":"chat-text",
    "to":".*",
    "encrypted":true,
    "content":{
...
**Request:**
```bash
curl 'https://hmdevonline.com/messaging-api/origin-service/disconnect'   --data-raw '{"session":"da44fb94d3d04833a8c5755c791dfb84"}'
```
