...
public final class SessionRecoveryUtility {
    private SessionRecoveryUtility() { /* no instances */ }

    private static final Logger logger = LoggerFactory.getLogger(SessionRecoveryUtility.class);
